//AIM:
    //To understand the concept of Linked List and perform basic operations
    //such as insertion, deletion and traversal using a Singly Linked List (SL)
//algorithm:
    //Step 1: Start
    //Step 2: Create a structure 'node' with data and next pointer.
    //Step 3: Initialize head = NULL.
   // Step 4: Create a new node using dynamic memory (malloc).
    //Step 5: Assign data to the new node.
    //Step 6: If head is NULL:
       //         head = newnode
         //   Else:
