/*
    AIM:
    ----
    To implement BFS (Level Order Traversal) on a binary tree using a queue.
    ...
    Step 2: Create a structure 'node' with:
                ...
                - left child pointer
                - right child pointer
    Step 3: Insert nodes to form a binary tree
    Step 4: For BFS, use a queue:
                - Enqueue root node
                - While queue is not empty:
                        - Dequeue a node and print it
                        - If left child exists, enqueue left
                        - If right child exists, enqueue right
    Step 5: Stop
*/
#include <stdio.h>
#include <stdlib.h>
