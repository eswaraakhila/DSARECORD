/*
    AIM:
    ----
    To implement DFS traversals (Preorder, Inorder, Postorder)
    on a binary tree using recursion.
    ...
    Step 1: Traverse left subtree in inorder
    Step 2: Visit root node
    Step 3: Traverse right subtree in inorder

    POSTORDER (Left → Right → Root):
    Step 1: Traverse left subtree in postorder
    Step 2: Traverse right subtree in postorder
